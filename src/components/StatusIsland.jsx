...
export default function StatusIsland({ 
  ...
  return (
    ...
    >
      ...
      >
        {/* 展开内容区 - 仅在有建议时显示 */}
        <div className={`flex items-center transition-all duration-500 ease-out ${showActions ? 'max-w-[600px] opacity-100' : 'max-w-0 opacity-0'}`}>
        ...
        {/* 分隔线 - 仅在展开时显示 */}
        <div className={`w-px h-3 bg-gray-200/80 mx-1 transition-opacity duration-300 ${showActions ? 'opacity-100' : 'opacity-0'}`} />
