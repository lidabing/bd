  ...
  return (
    <div className="flex flex-col h-screen overflow-hidden font-sans text-[#3c4043] bg-white">
      ...
      <div className="flex-1 relative flex overflow-hidden bg-white">
        ...
        <div className={`flex-1 h-full overflow-y-auto custom-scrollbar transition-all duration-300 ease-in-out ${sidePanelOpen ? 'mr-[400px]' : 'mr-0'}`}>
          <PageContent type={activeTab?.type} />
        </div>
        
        {/* Sidebar Container - Absolute positioned */}
        <div className={`absolute top-0 right-0 bottom-0 w-[400px] pointer-events-none ${sidePanelOpen ? 'pointer-events-auto' : ''}`}>
          <SidePanel 
            open={sidePanelOpen} 
